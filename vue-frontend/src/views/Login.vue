<template>
  <div class="tw-min-h-screen tw-bg-gradient-to-b tw-from-indigo-50 tw-to-white tw-flex tw-flex-col">
    ...
    <header class="tw-sticky tw-top-0 tw-z-20 tw-bg-white tw-border-b tw-border-gray-200 tw-backdrop-blur">
      <nav class="tw-max-w-7xl tw-mx-auto tw-flex tw-items-center tw-justify-between tw-px-6 tw-h-16">
    ...
    <section class="tw-flex-1">
      <div class="tw-max-w-7xl tw-mx-auto tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-12 tw-items-center tw-px-6 tw-pt-16 tw-pb-12">
        ...
        <!-- Login card -->
        <div class="tw-bg-white tw-rounded-2xl tw-shadow-xl tw-border tw-border-gray-100 tw-p-8 tw-relative">
          ...
          <form class="tw-mt-6 tw-space-y-4" @submit.prevent="handleLogin">
            <div>
              ...
              <input
                ...
                class="tw-mt-1 tw-w-full tw-border tw-border-gray-300 tw-rounded-lg tw-px-3 tw-py-2 focus:tw-ring-2 focus:tw-ring-indigo-500 focus:tw-border-indigo-500 tw-outline-none"
              />
            </div>
            ...
            <div class="tw-flex tw-items-center tw-justify-between">
              <label class="tw-flex tw-items-center tw-gap-2 tw-text-sm tw-text-gray-700">
                <input type="checkbox" v-model="rememberMe" class="tw-h-4 tw-w-4 tw-rounded tw-border-gray-300 focus:tw-ring-indigo-500" />
            ...
            <button type="submit" :disabled="isLoading"
              class="tw-w-full tw-inline-flex tw-justify-center tw-items-center tw-gap-2 tw-bg-indigo-600 hover:tw-bg-indigo-700 tw-text-white tw-font-semibold tw-rounded-lg tw-px-4 tw-py-2.5 tw-transition disabled:tw-opacity-60 disabled:tw-cursor-not-allowed">
            ...
            <p v-if="error" class="tw-text-sm tw-text-red-600 tw-text-center">{{ error }}</p>
          </form>
        </div>
      </div>
    </section>
