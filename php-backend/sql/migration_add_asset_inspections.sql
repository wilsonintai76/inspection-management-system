-- Migration: Add asset inspection tracking tables
-- This allows admins to upload merged Excel/CSV files of uninspected assets
-- and generate department summaries
